  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <span
          className={`rounded-sm border px-2 py-0.5 font-sans text-xs font-semibold uppercase tracking-widest ${pillStyles[concept.classification]}`}
        >
      ...
      {concept.definition && (
        <div className="flex flex-col gap-2">
          <h4 className="font-sans text-xs font-semibold uppercase tracking-widest text-ad-text-muted">
            Definition
          </h4>
