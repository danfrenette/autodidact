...
RSpec.describe Tag, type: :model do
  ...
  describe ".normalize_name" do
    it "downcases, strips, and converts spaces to hyphens" do
      expect(Tag.normalize_name(" Distributed   Systems ")).to eq("distributed-systems")
    end

    it "handles single word names" do
      expect(Tag.normalize_name("Ruby")).to eq("ruby")
    end

    it "handles empty strings" do
      expect(Tag.normalize_name("")).to eq("")
    end
  end
end
